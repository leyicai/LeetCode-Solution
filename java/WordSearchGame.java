...
————————————————
版权声明：本文为CSDN博主「Qing_yun」的原创文章，遵循 CC 4.0 BY-SA 版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/qing_yun/article/details/46865863
public class WordSearchGame {
    ...
    public static void main(String[] args) {
        ...
        try {
            brname = new BufferedReader(new FileReader("input.json"));// 读取NAMEID对应值
            String sname = null;
        ...
        // 读取原始json文件并进行操作和输出
        try {
            BufferedReader br = new BufferedReader(new FileReader("input.json"));// 读取原始json文件
            BufferedWriter bw = new BufferedWriter(new FileWriter("src/json/HK_new.json"));// 输出新的json文件
